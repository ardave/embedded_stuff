...
#define SensorReading_init_default {0, 0, 0, 0, ""}
#define SensorReading_init_zero {0, 0, 0, 0, ""}
...
#define SensorReading_timestamp_unix_tag 4
#define SensorReading_device_id_tag 5
...
#define SensorReading_FIELDLIST(X, a) \
    ...
    X(a, STATIC, SINGULAR, INT64, timestamp_unix, 4) \
